...
</li>`).join("");r.insertAdjacentHTML("beforeend",o),c.refresh()}function p(){const e=document.querySelector(".gallery");e&&(e.innerHTML="",c.refresh())}function g(){const e=document.querySelector(".load");e.hidden=!1,e.classList.add("loader")}function y(){const e=document.querySelector(".load");e.hidden=!0,e.classList.remove("loader")}const h="https://pixabay.com/api/",L="52758797-16c779dc2baa00e6d4d028fc2";function S(e){const r={key:L,q:e,image_type:"photo",orientation:"horizontal",safesearch:!0};return f.get(`${h}`,{params:r}).then(o=>o).catch(o=>o)}document.querySelector(".container");const b=document.querySelector(".form"),i=document.querySelector(".form-text");let l="";b.addEventListener("submit",e=>{e.preventDefault(),g(),l=i.value.trim().toLowerCase(),p(),l&&(S(l).then(r=>{if(r.data.hits.length===0)return d.warning({backgroundColor:"#EF4040",message:"Sorry, there are no images matching your search query. Please try again!",messageColor:"#FAFAFB",iconUrl:"./img/bi_x-octagon.svg",closeOnEscape:!0});const o=r.data.hits;m(o)}).catch(r=>{console.error("Виникла помилка:",r)}).finally(y),i.value="")});
